...
urlpatterns = [
    ...
    url(r'^report_by_worker/$', views.report_by_worker, name='report_by_worker'),
    url(r'^report_by_product/$', views.report_by_product, name='report_by_product'),
